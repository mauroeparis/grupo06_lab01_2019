...
dibujo_u escher = (.-.) ((.-.) escher2 (rot90 escher2)) ((.-.) (rot90 (rot90 escher2)) (rot90 (rot90 (rot90 escher2))))
                  where escher2 = rot90(rotar45(escher))
...
dibujo_t escher = (^^^) escher ((^^^) escher2 escher3)
              where escher2 = rot90(rotar45 escher)
                    escher3 = rot90(rot90(rot90 escher2))
...
esquina n escher = (.-.) ((///) (esquina (n-1) escher) (lado n escher)) ((///) (rot90(lado n escher)) (dibujo_u escher))
...
noneto p q r s t u v w x = (.-.) ((///) p ((///) q r)) ((.-.) ((///) s ((///) t u)) ((///) v ((///)w x)))
...
-- -- el dibujo de Escher:
escher :: Float -> Dibujo Escher -> Dibujo Escher
escher n escher = noneto (esquina n escher) (esquina n escher) (rot90(rot90(rot90(esquina n escher))))
                  (rot90(esquina n escher)) (dibujo_u escher) (rot90(rot90(rot90(esquina n escher))))
                  (rot90(esquina n escher)) (rot90(rot90(esquina n escher))) (rot90(rot90(esquina n escher)))
